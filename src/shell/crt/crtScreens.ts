...
const BLUE_LINES: BlueLine[] = [
  { text: "KELLY.OS HALTED", tone: "head" }, { text: "" },
  { text: "You shut the system down. The desktop, the window" },
  { text: "manager, and every open app have been stopped." }, { text: "" },
  { text: "*  Nothing was lost. This is a portfolio, not a real" },
  { text: "   machine — your session simply ended." }, { text: "" },
  { text: "*  New visitors always boot the newest version. Coming" },
  { text: "   back starts a fresh cold boot from the countdown." }, { text: "" },
  { text: "Technical information:", tone: "bright" }, { text: "" },
  { text: "***  STOP: 0x00KELL05  (session ended by user)" },
  { text: "***  SHELL.SYS  -  Kelly.OS 3.0  ·  Saathvik Kellampalli" }, { text: "" },
];
...
const paintBlueScreen: ScreenPainter = (context, width, height, time) => {
  ...
  context.fillText(dump >= 100 ? "Session archived." : `Flushing phosphor buffers: ${pad(dump, 2)}%`, left, y);
  y += lineHeight * 2;
  const prompt = "Press any key to power back on ";
